...
// was not loaded in eager-loading.
func (e UserEdges) BattingRecordsOrErr() ([]*BatterRecord, error) {
	if e.loadedTypes[1] {
...
// was not loaded in eager-loading.
func (e UserEdges) PitchingRecordsOrErr() ([]*PitcherRecord, error) {
	if e.loadedTypes[2] {
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldEmail, user.FieldPassword, user.FieldName, user.FieldTeam:
...
// QueryBattingRecords queries the "batting_records" edge of the User entity.
func (u *User) QueryBattingRecords() *BatterRecordQuery {
	return NewUserClient(u.config).QueryBattingRecords(u)
}

// QueryPitchingRecords queries the "pitching_records" edge of the User entity.
func (u *User) QueryPitchingRecords() *PitcherRecordQuery {
	return NewUserClient(u.config).QueryPitchingRecords(u)
}
